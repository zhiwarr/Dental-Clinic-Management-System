    ...
    <div class="row">
        <div class="col-75">
            <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-50">
                            ...
                            <div class="icon-container">
                                <fieldset>
                                    <input type="radio" name="payment_method" value="Cash/Debit" checked="true">
                                    Cash/Debit <br>
                            ...
                            <label for="cname">Patient Amount<span class="error" style="color:red;"> *
                                    <?php echo $patientAmountErr; ?></span></label>
                            <input type="text" id="patientAmount" name="patientAmount"
                                placeholder="Enter amount (Canadian dollars)">
                            <label for="ccnum">Insurance Amount (if applicable) <span class="error"
                                    style="color:red;"><?php echo $insuranceAmountErr; ?></span></label>
                            <input type="text" id="insuranceAmount" name="insuranceAmount"
                                placeholder="Enter amount (Canadian dollars)">
                        </div>
                ...
                <br>
                <br>
                <input class="btn" type="button" value="Return to patient landing page"
                    onClick="document.location.href='patient_landing.php'" />
                <br>
                <br>
            </div>
        </div>
